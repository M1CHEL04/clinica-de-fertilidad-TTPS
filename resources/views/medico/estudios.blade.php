...
<style>
    ...
    .opcion-desactivada {
        ...
        background-color: #e9ecef; /* Fondo más apagado */
    }
        ...
        <div class="card-body p-4">
            ...
            <form action="{{ session('rol') == 2 ? route('estudios.store') : route('jefe.estudios.store') }}" method="POST">
                ...
                <div class="mb-4 p-3 border rounded">
                    <label class="form-label fw-bold text-primary"><i class="fas fa-venus me-2"></i> Estudios Ginecológicos</label>
                    <div class="d-flex mb-2">
                        <select id="ginecologicos-select" class="form-select me-2">
                            <option value="">Seleccione un estudio...</option>
                            @foreach($ginecologicos as $estudio)
                                <option value="{{ $estudio['id'] }}" data-nombre="{{ $estudio['nombre'] }}">{{ $estudio['nombre'] }}</option>
                            @endforeach
                        </select>
                        <button type="button" id="add-ginecologico" class="btn btn-outline-primary flex-shrink-0"><i class="fas fa-plus me-1"></i> Agregar</button>
                    </div>
                ...
                <div class="mb-4 p-3 border rounded">
                    <label class="form-label fw-bold text-primary"><i class="fas fa-flask me-2"></i> Estudios Hormonales</label>
                    <div class="d-flex mb-2">
                        ...
                        <button type="button" id="add-hormonal" class="btn btn-outline-primary flex-shrink-0"><i class="fas fa-plus me-1"></i> Agregar</button>
                    </div>
                ...
                <div class="mb-4 p-3 border rounded">
                    <label class="form-label fw-bold text-primary"><i class="fas fa-heartbeat me-2"></i> Prequirúrgicos</label>
                    <div class="d-flex mb-2">
                        ...
                        <button type="button" id="add-prequirurgico" class="btn btn-outline-primary flex-shrink-0"><i class="fas fa-plus me-1"></i> Agregar</button>
                    </div>
                ...
                <div class="mb-4 p-3 border rounded">
                    <label class="form-label fw-bold text-primary"><i class="fas fa-tint me-2"></i> Estudios de Semen</label>
                    <div class="d-flex mb-2">
                        ...
                        <button type="button" id="add-semen" class="btn btn-outline-primary flex-shrink-0"><i class="fas fa-plus me-1"></i> Agregar</button>
                    </div>
