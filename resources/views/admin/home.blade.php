        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th class="text-center align-middle w-20">Acciones</th>
                </tr>
            </thead>
            <tbody id="staff-table">
                ...
                <tr>
                    <td>
                        <div class="flex items-center">
                            <div class="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center mr-3">
                                <span class="text-white text-sm font-medium">{{ strtoupper(substr($usuario->nombre,0,1)) }}{{ strtoupper(substr($usuario->apellido,0,1)) }}</span>
                            </div>
                            <div>
                    ...
                    <td>
                        <span class="badge {{ $usuario->activo ? 'badge-success' : 'badge-error' }}">{{ $usuario->activo ? 'Activo' : 'Inactivo' }}</span>
                    </td>
