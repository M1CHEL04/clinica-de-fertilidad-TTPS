            ...
            <div>
                ...
                <div class="flex flex-row justify-center gap-4">
                    @foreach($roles as $rol)
                        <label class="flex items-center cursor-pointer border border-gray-300 rounded-lg px-4 py-2 transition-colors hover:border-blue-500">
                            <input type="radio" name="rol" value="{{ $rol->id }}" class="form-radio text-blue-600 focus:ring-blue-500" {{ old('rol') == $rol->id ? 'checked' : '' }} required>
