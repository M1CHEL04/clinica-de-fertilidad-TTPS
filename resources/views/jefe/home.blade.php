...
@section('page-header')
    <div class="page-header">
        <div>
         ...
         <!-- Botón Ver Pagos -->
            <a href="{{ route('jefe.usuarios.index') }}" class="btn-secondary inline-flex items-center">
    ...
    <div x-data="{
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="card p-6">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-600 mb-1">En tratamiento</p>
            ...
            <div class="card p-6">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-600 mb-1">Pacientes jóvenes (≤35 años)</p>
                        <p class="text-2xl font-bold text-gray-900">
                            @php
                                $pacientesJovenes = 0;
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    "
                                        ...
                                        <a href="{{ route('jefe.primerConsulta.create', $paciente->paciente_id) }}"
                                            class="p-2 text-green-600 hover:bg-green-50 rounded-lg" title="Nueva Consulta">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                <template x-for="tratamiento in tratamientos" :key="tratamiento.id">
                                    <tr class="hover:bg-gray-100 transition-colors">
                                        ...
                                        <td class="p-3 text-sm">
                                            <a :href="`/jefe/paciente/${tratamiento.id}/tratamiento`"
